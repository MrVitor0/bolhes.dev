...
O lowering Ruby/Python cobre blocos simples; retorno implicito, projeto multi-arquivo, source maps remapeados e Worker web ainda estao pendentes. O registry documenta gestos e exemplos, mas os predicates implementados so verificam evidencia sintatica; consulte [sdd/roadmap.md](sdd/roadmap.md).
